...
function onDocumentLoad() {
	...
	button.id = 'button';
	button.innerHTML = `<img src="${pathname.substring( 0, pathname.indexOf( 'PyWeb3D' ) + 7 )}/files/ic_mode_edit_black_24dp.svg">`;
	console.log(`${pathname.substring( 0, pathname.indexOf( 'PyWeb3D' ) + 7 )}/files/ic_mode_edit_black_24dp.svg`)
	...
	styleBase.href = pathname.substring( 0, pathname.indexOf( 'PyWeb3D' ) + 7 ) + '/prettify/prettify.css';
	styleBase.rel = 'stylesheet';

	const styleCustom = document.createElement( 'link' );
	styleCustom.href = pathname.substring( 0, pathname.indexOf( 'PyWeb3D' ) + 7 ) + '/prettify/threejs.css';
	...
	prettify.src = pathname.substring( 0, pathname.indexOf( 'PyWeb3D' ) + 7 ) + '/prettify/prettify.js';
